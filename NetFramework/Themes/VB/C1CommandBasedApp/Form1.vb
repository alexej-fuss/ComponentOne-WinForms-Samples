...
Partial Public Class Form1
   ...
   Private Sub Form1_Closing(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
      If _dataSource = "SQL" Then
         Me.employeesTableAdapter.Adapter.Update(Me.c1NWINDDataSet1.Employees)
      ElseIf ConfigurationManager.AppSettings.Item("C1DataSource") = "Access" Then
   ...
   Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
      ...
      Me.c1FlexGrid1.BeginUpdate()
      _dataSource = ConfigurationManager.AppSettings.Item("C1DataSource")

      If _dataSource = "SQL" Then
         Me.c1FlexGrid1.DataSource = Me.employeesBindingSource1
         Me.EmployeesTableAdapter1.Fill(Me.C1NWINDDataSet1.Employees)
      ElseIf ConfigurationManager.AppSettings.Item("C1DataSource") = "Access" Then
